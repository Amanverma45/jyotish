          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-7 space-y-5">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                <a
                  href={`https://api.whatsapp.com/send?phone=919826525736&text=${encodeURIComponent(isHindi ? "जय श्री महाकाल! पं. हरिओम शर्मा जी से गणेश चतुर्थी 2026 गणपति स्थापना एवं अनुष्ठान पूजन बुक करना चाहता/चाहती हूँ।" : "Jai Shree Mahakal! I want to book Ganesh Chaturthi 2026 Puja with Pt. Hariom Sharma Ji.")}`}
                  target="_blank"
              ...
              return (
                ...
                >
                  ...
                  <div className="pt-4 border-t border-amber-100 mt-4 flex items-center justify-between">
                    ...
                    <a
                      href={`https://api.whatsapp.com/send?phone=919826525736&text=${encodeURIComponent(isHindi ? `जय श्री महाकाल! पं. हरिओम शर्मा जी से ${item.title} पर पूजा परामर्श हेतु संपर्क।` : `Jai Shree Mahakal! Consulting Pt. Hariom Sharma Ji for ${item.title}.`)}`}
                      target="_blank"
                      rel="noopener noreferrer"
