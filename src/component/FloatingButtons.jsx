    ...
    <>
      ...
      >
        ...
        <div className="relative group animate-float-slow">
          ...
          <a
            href={`https://api.whatsapp.com/send?phone=919826525736&text=${encodeURIComponent(isHindi ? "जय श्री महाकाल! पं. हरिओम शर्मा जी से पूजन हेतु संपर्क करना चाहता/चाहती हूँ।" : "Jai Shree Mahakal! I would like to consult Pt. Hariom Sharma Ji for Puja.")}`}
            target="_blank"
      ...
      {showTopBtn && (
        <div className="fixed bottom-4 right-3 sm:right-6 z-50 group animate-fade-in">
          <button
            ...
            className="relative flex items-center justify-center w-11 h-11 sm:w-13 sm:h-13 rounded-full bg-gradient-to-tr from-red-950 via-slate-900 to-red-900 hover:from-red-900 hover:to-amber-900 text-amber-300 border-2 border-amber-400/80 shadow-2xl hover:scale-115 active:scale-95 transition-all duration-300 cursor-pointer group"
          >
